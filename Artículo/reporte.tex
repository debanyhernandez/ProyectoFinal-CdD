...
\usepackage[
  ...
  pdftitle={Segmentación de Clientes según su Perfil de Endeudamiento},
  colorlinks=true,
  linkcolor=Accent,
  citecolor=Accent,
  urlcolor=Accent
...
\begin{center}
\vspace*{0.5em}
{\LARGE \textbf{\color{Accent}Segmentación de Clientes según su Perfil de Endeudamiento}\par}
\vspace{0.5em}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{matriz_correlacion.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.95\textwidth]{metodo_del_codo_kmeans.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.90\textwidth]{silhouette_vs_k_kmeans.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.90\textwidth]{segmentacion_radar_clusters.png}
...
la población analizada y permiten interpretar la segmentación no supervisada de forma coherente en términos 
de morosidad, endeudamiento y capacidad económica. Además, estos resultados sientan una base sólida para 
análisis posteriores orientados a riesgo crediticio, predicción de incumplimiento o diseño de estrategias 
de seguimiento y apoyo a clientes.
